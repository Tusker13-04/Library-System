...
try:
    ...
    df = pd.DataFrame({"book": ["Adventures of Tom Sawyer", "Alice in Wonderland", "Origin of Species"],
                       "author": ["Mark Twain", "Lewis Carrol", "Charles Darwin"], "price": [100, 200, 150],
                       "status": ["available", "rent", "sold"]})
